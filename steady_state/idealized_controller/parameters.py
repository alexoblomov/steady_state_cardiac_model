...
Hu_patient = 0.5*34 # (heart 2 eyeball)
Hl_patient = -0.5*45 # (heart 2 seat)
...
Csa_l = Hl_factor * (0.86*0.00175 / 1333) * 1000
Csa_u = Hu_factor * (0.86*0.00175 / 1333) * 1000
